...
if __name__ == '__main__':
    ...
    train_set = TrainDatasetFromFolder('/dockerx/data/train', crop_size=CROP_SIZE, upscale_factor=UPSCALE_FACTOR)
    val_set = ValDatasetFromFolder('/dockerx/data/val', upscale_factor=UPSCALE_FACTOR)
